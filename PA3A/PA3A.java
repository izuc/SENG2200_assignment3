...
/**
* The PA3A class is the main class (which is static) in the application. It contains the main method (which invokes the other 
...
public class PA3A {
	...
	*/
	private static Event factory(int dataType, String name, String country) {
		if (dataType == 1) {
			return new Distance(name, country);
		}
		return null;
	}
